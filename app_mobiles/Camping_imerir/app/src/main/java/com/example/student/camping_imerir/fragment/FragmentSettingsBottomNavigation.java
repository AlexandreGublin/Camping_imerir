...
public class FragmentSettingsBottomNavigation extends Fragment {

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {

        // Select the ViewFragment by the onItemClick
        View rootview = inflater.inflate(R.layout.fragment_settings_bottom_navigation, container, false);
